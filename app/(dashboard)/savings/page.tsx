...
export default function SavingsPage() {
    const asset = ASSET_CLASSES.savings;
                        ...
                        <CardContent>
                            <div className="text-sm space-y-3">
                                ...
                                <p className="text-muted-foreground pt-2 leading-relaxed">
                                    Savings accounts are federally insured (FDIC) and offer a guaranteed return,
                                    making them ideal for short-term goals and emergency funds. They essentially carry zero risk of principal loss.
                                </p>
                            </div>
                        </CardContent>
                    </Card>
