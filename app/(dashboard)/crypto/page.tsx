...
export default function CryptoPage() {
    const asset = ASSET_CLASSES.crypto;
                        ...
                        <CardContent>
                            <div className="text-sm space-y-3">
                                ...
                                <p className="text-muted-foreground pt-2 leading-relaxed">
                                    Crypto assets are extremely volatile and speculative. They offer the potential for massive gains
                                    but also the risk of losing significant value (up to 80-90% drawdowns). Invest only what you can lose.
                                </p>
                            </div>
                        </CardContent>
                    </Card>
