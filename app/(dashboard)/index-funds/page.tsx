...
export default function IndexFundsPage() {
    const asset = ASSET_CLASSES.indexFunds;
                        ...
                        <CardContent>
                            <div className="text-sm space-y-3">
                                ...
                                <p className="text-muted-foreground pt-2 leading-relaxed">
                                    Index funds (like S&P 500) provide broad market exposure. They offer high growth potential over decades
                                    but can be volatile in the short term. Best for retirement and long-term wealth building.
                                </p>
                            </div>
                        </CardContent>
                    </Card>
